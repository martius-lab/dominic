...
class RolloutBuffer:
    ...
    def compute_returns(self, last_ext_values, last_int_values, last_fixed_values, last_loose_values, gamma, lam):
        ext_advantage = 0
        int_advantage = 0
        fixed_advantage = 0
        loose_advantage = 0
        ...
        for epoch in range(num_epochs):
            for i in range(num_mini_batches):
                ...
                yield obs_batch, actions_batch, target_ext_values_batch, target_int_values_batch, \
                    target_fixed_values_batch, target_loose_values_batch, \
                    ext_advantages_batch, int_advantages_batch, fixed_advantages_batch, loose_advantages_batch, \
                    ext_returns_batch, int_returns_batch, fixed_returns_batch, loose_returns_batch, \
