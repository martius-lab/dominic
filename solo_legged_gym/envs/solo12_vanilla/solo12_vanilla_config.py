...
class Solo12VanillaEnvCfg(BaseEnvCfg):
    ...
    class rewards(BaseEnvCfg.rewards):
        class terms:  # [group, sigma]
            lin_vel_x = {"group": "task", "sigma": 0.2}
            lin_vel_y = {"group": "task", "sigma": 0.2}
            ang_vel_z = {"group": "task", "sigma": 0.2}

            lin_z = {"group": "task", "sigma": 0.4}
            lin_vel_z = {"group": "task", "sigma": 1.0}
            ang_xy = {"group": "task", "sigma": 0.6}
            ang_vel_xy = {"group": "task", "sigma": 3.0}

            joint_default = {"group": "task", "sigma": 1.5}
            joint_targets_rate = {"group": "task", "sigma": 0.8}
            feet_slip = {"group": "task", "sigma": 0.1}
            stand_still = {"group": "task", "sigma": 1.0}
            torques = {"group": "task", "sigma": 10.0}
